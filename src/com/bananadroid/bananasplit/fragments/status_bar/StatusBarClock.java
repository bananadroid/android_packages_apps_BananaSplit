...
package com.bananadroid.bananasplit.fragments.status_bar;
...
import com.bananadroid.support.preferences.CustomSettingsPreferenceFragment;
...
@SearchIndexable
public class StatusBarClock extends CustomSettingsPreferenceFragment implements Preference.OnPreferenceChangeListener, Indexable {
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<SearchIndexableResource> getXmlResourcesToIndex(Context context,
                    ...
                    sir.xmlResId = R.xml.status_bar_clock;
                    result.add(sir);
                    return result;
                }

...
package com.bananadroid.bananasplit.fragments.buttons;
...
import com.android.internal.util.banana.CustomUtils;
...
public class Buttons extends CustomSettingsPreferenceFragment implements Preference.OnPreferenceChangeListener, Indexable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!CustomUtils.deviceSupportsFlashLight(getContext())) {
    ...
    public static final SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider() {
                ...
                public List<String> getNonIndexableKeys(Context context) {
                    ...
                    if (!CustomUtils.deviceSupportsFlashLight(context)) {
